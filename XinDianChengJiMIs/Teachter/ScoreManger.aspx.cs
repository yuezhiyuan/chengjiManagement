...
public partial class Teachter_ScoreManger : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            DropDownList3.DataSource = data.GetDataReader("select * from  XueQi  ");
    ...
    public DataSet GetCodeBy(int iCount)
    {
        ...
        string sql = "select  " + strTop + "  * from [Score] where ClassID='" + DropDownList1.SelectedValue + "'     and CourseId ='" + DropDownList2.SelectedValue + "' and  XueQi='" + DropDownList3.SelectedItem.Text + "' ";
