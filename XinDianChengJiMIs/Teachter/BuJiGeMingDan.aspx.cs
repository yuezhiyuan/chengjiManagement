...
public partial class Teacher_BuJiGeMingDan : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            DropDownList3.DataSource = data.GetDataReader("select * from ClassInfo    ");
    ...
    public DataSet GetCodeBy(int iCount)
    {
        ...
        string sql = "select  " + strTop + "  * from [Score]  where   XueQi='" + DropDownList1.SelectedItem.Text + "' and CourseId ='" + DropDownList2.SelectedValue + "'  and ClassID='" + DropDownList3.SelectedValue + "' and zong<60   ";
