...
public partial class Teacher_XueQiChengJi : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            DropDownList2.DataSource = data.GetDataReader("select * from  dbo.CourseInfo  where  TName= '" + Name+"'");
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            Label1.Text = Convert.ToString(float.Parse(sqlzongchengji) / float.Parse(sqlreshu));
