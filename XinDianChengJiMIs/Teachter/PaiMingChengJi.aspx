<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PaiMingChengJi.aspx.cs" Inherits="Teacher_PaiMingChengJi" %>
        ...
        <TR>
          ...
          <tr>
              <td align="center" height="2">
                  学期：<asp:DropDownList ID="DropDownList1" runat="server" Width="191px">
                    
                        
                                         
                  </asp:DropDownList>选择班级：<asp:DropDownList ID="DropDownList3" runat="server" Width="168px">
                  </asp:DropDownList>课程：<asp:DropDownList ID="DropDownList2" runat="server" Width="191px">
                  </asp:DropDownList>
                  <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="查询排名" /></td>
          </tr>
        <TR>
