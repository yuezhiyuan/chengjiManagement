...
public partial class Teachter_ModifyMyInfo : System.Web.UI.Page
{
    ...
    private void GetArticle()
    {
        ...
        SqlDataReader dr;
        dr = data.GetDataReader("select * from  Teachter where id=" + Session["adminid"].ToString());
        dr.Read();
        ...
        DropDownList2.Items.FindByText(dr["XueYuan"].ToString()).Selected = true;//选项Text  
    ...
    protected void LinkButton1_Click(object sender, EventArgs e)
    {
        ...
        data.RunSql("update   Teachter set Name='" + txtname.Text + "',Ds='" + txtds.Text + "',Sex='" + DropDownList1.SelectedItem.Text + "', XueYuan='" + DropDownList2.SelectedItem.Text + "', Photo='" + pic.Text + "',GongHao='" + txtLoginName.Text + "',chushengriqi='" + txttime1.Value + "'  where id=" + Session["adminid"].ToString());
