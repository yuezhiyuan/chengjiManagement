<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ZhuanYeManger.aspx.cs" Inherits="Admin_ZhuanYeManger" %>
        ...
        <TR>
          ...
          <tr>
              <td align="center" height="2">
                  <asp:LinkButton ID="LinkButton1" runat="server" OnClick="LinkButton1_Click">添加专业</asp:LinkButton></td>
          </tr>
        <TR>
                          ...
                          <asp:GridView ID="gvInfo" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                             ...
                             <asp:TemplateField HeaderText="所属学院">
                                  ...
                                  <asp:TemplateField HeaderText="修改">
                                      <ItemTemplate>
                                          <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "ModifyZhuanYe.aspx?id="+Eval("id") %>'
