...
public partial class Admin_MangerXiBuInfo : System.Web.UI.Page
{
    ...
    {
        bool isOK = false;
        string sql = "delete from [XueYuanInfo] where id=" + id;
    ...
    public DataSet GetCodeBy(int iCount)
    {
        ...
        string sql = "select  " + strTop + "  * from [XueYuanInfo]";
        SqlConnection con = new SqlConnection(SqlHelper.connstring);
        SqlCommand cmd = new SqlCommand(sql, con);
    ...
    {
        Response.Redirect("AddXiBuInfo.aspx");
