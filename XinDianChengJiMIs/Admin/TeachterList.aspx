<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TeachterList.aspx.cs" Inherits="Admin_TeachterList" %>
...
<TABLE cellSpacing=0 cellPadding=0 width="98%" border=0>
  ...
  <TR>
        ...
        <TR>
          <TD height=2 align="left">
                ...
                <asp:TemplateField HeaderText="性别">
                    ...
                    <ItemTemplate>
                        <asp:Label ID="ZhiCheng" runat="server" Text='<%# Bind("ZhiCheng") %>'></asp:Label>
                    </ItemTemplate>
                    <ItemStyle HorizontalAlign="Left" Width="80px" />
                </asp:TemplateField>
                <asp:TemplateField HeaderText="学院">
                    <ItemTemplate>
                        <asp:Label ID="Label13" runat="server" Text='<%# Bind("XueYuan") %>'></asp:Label>
                    </ItemTemplate>
                    <ItemStyle HorizontalAlign="Left" Width="80px" />
                </asp:TemplateField>
                <asp:TemplateField HeaderText="登陆账号">
                    <ItemTemplate>
                        <asp:Label ID="Label131" runat="server" Text='<%# Bind("GongHao") %>'></asp:Label>
                    </ItemTemplate>
                    <ItemStyle HorizontalAlign="Left" Width="80px" />
                </asp:TemplateField>
             ...
             <ItemStyle HorizontalAlign="Left" Width="100px" />
                ...
                <asp:TemplateField HeaderText="查看/修改">
                    <ItemTemplate>
                        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "ModifyTechter.aspx?id="+Eval("id") %>'
    ...
    <asp:FileUpload ID="fulImport" runat="server" Height="20px" Width="120px" />
    <asp:Button ID="btnImport" runat="server" Text="批量上传" Width="80px" Height="20px" OnClick="btnImport_Click" /> 
                          &nbsp;&nbsp;
          </TD></TR></TABLE>
      </TD>
