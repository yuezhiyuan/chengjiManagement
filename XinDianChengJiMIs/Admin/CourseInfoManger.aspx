<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CourseInfoManger.aspx.cs" Inherits="Admin_CourseInfoManger" %>
        ...
        <TR>
          ...
          <tr>
              <td align="center" height="2">
                  课程名称：<asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
          ...
          <TD height=2 align="left">
                          <asp:GridView ID="gvInfo" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                             ...
                             <asp:TemplateField HeaderText="专业">
                                      <ItemTemplate>
                                          <asp:Label ID="ZhuanYeName" runat="server" Text='<%# Bind("ZhuanYeName") %>' Width="120px"></asp:Label>
                                      </ItemTemplate>
                                      <ItemStyle HorizontalAlign="Left" Width="120px" />
                                  </asp:TemplateField>
                               ...
                               <asp:TemplateField HeaderText="授课教师">
                                  ...
                                  <asp:TemplateField HeaderText="课时">
                                      <ItemTemplate>
                                          <asp:Label ID="ZhouQi" runat="server" Text='<%# Bind("ZhouQi") %>'></asp:Label>
                                      </ItemTemplate>
                                      <ItemStyle HorizontalAlign="Left" Width="100px" />
                                  </asp:TemplateField>
                                  ...
                                  <asp:TemplateField HeaderText="时间">
                                      <ItemTemplate>
                                          <asp:Label ID="ShengKeSJ" runat="server" Text='<%# Bind("ShengKeSJ") %>'></asp:Label>
                                      </ItemTemplate>
                                      <ItemStyle HorizontalAlign="Left" Width="100px" />
                                  </asp:TemplateField>
                                      ...
                                      <ItemTemplate>
                                          <asp:Label ID="XueFen" runat="server" Text='<%# Bind("XueFen") %>'></asp:Label>
                                      </ItemTemplate>
                                      <ItemStyle HorizontalAlign="Left" Width="100px" />
                                  </asp:TemplateField>
                                  <asp:TemplateField HeaderText="修改">
                                      <ItemTemplate>
                                          <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "ModifyCourseInfo.aspx?id="+Eval("id") %>'
