<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MangerXiBuInfo.aspx.cs" Inherits="Admin_MangerXiBuInfo" %>
        ...
        <TR>
          ...
          <tr>
              <td align="center" height="2">
                  <asp:LinkButton ID="LinkButton1" runat="server" OnClick="LinkButton1_Click">添加学院</asp:LinkButton></td>
          </tr>
        <TR>
                          ...
                          <asp:GridView ID="gvInfo" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                              ...
                              <Columns>
                                  <asp:TemplateField HeaderText="学院名称">
                                      ...
                                      <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl='<%# "ZhuanYe.aspx?id="+Eval("id") %>'
                                  ...
                                  <asp:TemplateField HeaderText="主任">
                                      <ItemTemplate>
                                          <asp:Label ID="ZhuRen" runat="server" Text='<%# Bind("ZhuRen") %>'></asp:Label>
                                      </ItemTemplate>
                                      <ItemStyle HorizontalAlign="Left" Width="100px" />
                                  </asp:TemplateField>
                             <asp:TemplateField HeaderText="电话">
                                  ...
                                  <asp:TemplateField HeaderText="修改">
                                      <ItemTemplate>
                                          <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "ModifyXiBuInfo.aspx?id="+Eval("id") %>'
