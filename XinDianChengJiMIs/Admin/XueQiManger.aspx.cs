...
public partial class Admin_XueQiManger : System.Web.UI.Page
{
    ...
    public DataSet GetCodeBy(int iCount)
    {
        ...
        string sql = "select  " + strTop + "  * from [XueQi] ";
    ...
    {
        data.RunSql("insert into XueQi(name)values('" + TextBox1.Text + "')");
        Alert.AlertAndRedirect("添加成功", "XueQiManger.aspx");
