<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ZhuanYe.aspx.cs" Inherits="Admin_ZhuanYe" %>
                          ...
                          <asp:GridView ID="gvInfo" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                              ...
                              <Columns>
                                  <asp:TemplateField HeaderText="专业名称">
                                      <ItemTemplate>
                                          <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl='<%# "BanJi.aspx?id="+Eval("id") %>'
