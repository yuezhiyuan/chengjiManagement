<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JiaoShiManger.aspx.cs" Inherits="Admin_JiaoShiManger" %>
        ...
        <TR>
          ...
          <tr>
              <td align="center" height="2">
                  上课地点名称：<asp:TextBox ID="TextBox2" runat="server" Width="155px"></asp:TextBox>
        ...
        <TR>
          <TD height=2 align="left">
                          <asp:GridView ID="gvInfo" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                              ...
                              <Columns>
                                  <asp:TemplateField HeaderText="上课地点名称">
                                      <ItemTemplate>
                                  ...
                                  <asp:TemplateField HeaderText="修改">
                                      <ItemTemplate>
                                          <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "ModifyJiaoShi.aspx?id="+Eval("id") %>'
