<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ModifyTechter.aspx.cs" Inherits="Admin_ModifyTechter" %>
              ...
              <table align="center" border="0" cellpadding="3" cellspacing="1" class="" style="width: 100%">
                  ...
                  <tr>
                      ...
                      <td align="left" style="width: 621px;">
                          <asp:Image ID="Image1" runat="server" Width="126px" Height="79px" /><br />
                  ...
                  <tr>
                      <td class="left_title_1" style="width: 88px;">
                          个人描述：</td>
                      <td align="left" style="width: 621px;">
                          <asp:TextBox ID="txtds" runat="server" Height="42px" 
