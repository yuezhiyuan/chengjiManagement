<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddClassInfo.aspx.cs" Inherits="Admin_AddClassInfo" %>
  ...
  <TR>
    ...
    <TD vAlign=top width="100%" bgColor=#ffffff style="height: 61px">
      <TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
        <TR>
          <TD class=manageHead>当前位置：添加班级信息 </TD></TR>
        <TR>
          <TD height=2 align="center">
              <table id="Table1" align="center" border="0" cellpadding="5" cellspacing="0" width="100%">
                  <tr>
                      ...
                      <td>
                          选择专业：</td>
                      <td align="left"><asp:DropDownList ID="DropDownList2" runat="server" Width="132px">
                      </asp:DropDownList></td>
                  </tr>
                  ...
                  <tr style="color: #000000">
                      <td style="width: 71px">
                          班级人数：</td>
                      <td align="left" style="width: 245px">
                          <asp:TextBox ID="TextBox4" runat="server" Width="96px"></asp:TextBox></td>
                      <td>
                          班主任：</td>
                      <td align="left">
