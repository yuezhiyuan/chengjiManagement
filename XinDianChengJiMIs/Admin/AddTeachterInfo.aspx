<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddTeachterInfo.aspx.cs" Inherits="Admin_AddTeachterInfo" %>
  ...
  <TR>
    ...
    <TD vAlign=top width="100%" bgColor=#ffffff style="height: 61px">
      <TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
        <TR>
          <TD class=manageHead>当前位置：添加教师信息 </TD></TR>
        <TR>
              ...
              <table align="center" border="0" cellpadding="3" cellspacing="1" class="" style="width: 100%">
                  ...
                  <tr style="color: #000000">
                      <td class="left_title_1" style="width: 88px; height: 30px">
                          学院：</td>
                      <td align="left" style="width: 621px; height: 30px">
                          <asp:DropDownList ID="DropDownList2" runat="server" Width="113px">
                          </asp:DropDownList></td>
                  </tr>
                  <tr style="color: #000000">
                      <td class="left_title_1" style="width: 88px; height: 30px">
                  ...
                  <tr>
                      ...
                      <td align="left" style="width: 621px;">
                          <asp:Image ID="Image1" runat="server" Width="126px" Height="90px" /><br />
                  ...
                  <tr>
                      <td class="left_title_1" style="width: 88px;">
                          个人描述：</td>
                      <td align="left" style="width: 621px;">
                          <asp:TextBox ID="txtds" runat="server" Height="51px" OnTextChanged="txtds_TextChanged"
