<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MyScore.aspx.cs" Inherits="MyScore" %>
  ...
  <TR>
    ...
    <TD vAlign=top width="100%" bgColor=#ffffff style="height: 61px">
       <TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
        <TR AllowPaging="false">
          <TD class="manageHead">
              当前位置：我的成绩</TD></TR>
          <tr>
              <td align="center" style="height: 2px">
                  学期：<asp:DropDownList ID="DropDownList1" runat="server" Width="117px">
                  </asp:DropDownList>选择班级：<asp:DropDownList ID="DropDownList3" runat="server"  
                      Width="191px"  >
                  </asp:DropDownList>选择课程：<asp:DropDownList ID="DropDownList2" runat="server" Width="153px">
              </asp:DropDownList>
              <asp:TextBox  Visible="false" ID="txttag" runat="server" TextMode="SingleLine" Width="138px"></asp:TextBox>
        ...
        <TR>
          ...
          <tr>
              <td align="center" style="height: 2px">
                  &nbsp;<asp:Button ID="btnDel" runat="server" OnClick="btnDel_Click" OnClientClick="daochu()"
                      Text="导出到EXCEL打印" /> </td>
          </tr>
      </TABLE>
      </TD>
